...
class FixedGlassPane extends JPanel implements MouseListener, MouseMotionListener, FocusListener, KeyListener {
   ...
   * the user presses the check box then drags off, the check box isn't disarmed
   * -- it keeps its dark gray background or whatever its L&F uses to indicate
  ...
  public void keyReleased(KeyEvent e) {
    // do nothing
    System.out.println("aca hay una tecla released");
  }

  public void keyTyped(KeyEvent e) {
    // do nothing
    System.out.println("aca hay una tecla typed");
  }

  public void keyPressed(KeyEvent e) {
    // do nothing
    System.out.println("aca hay una tecla pressed");
  }
